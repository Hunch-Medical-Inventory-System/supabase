...
CREATE FUNCTION public.handle_new_user() RETURNS trigger
    ...
    AS $$
BEGIN
  INSERT INTO public.crew (id, first_name, last_name, created_at)
  VALUES (NEW.id, '', '', NOW());  -- Empty first_name & last_name, can be updated later
  RETURN NEW;
END;
$$;
...
--
-- Name: take_inventory(integer, integer, uuid); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public.take_inventory(p_inventory_id integer, p_quantity integer, p_user_id uuid) RETURNS boolean
    LANGUAGE plpgsql
    AS $$
DECLARE 
  i_quantity INT;
BEGIN
  ...
  SELECT quantity INTO i_quantity FROM inventory WHERE id = p_inventory_id;

  IF i_quantity - p_quantity < 0 THEN
    RAISE EXCEPTION 'Quantity not large enough for transaction';
  END IF;
  ...
  IF EXISTS (
    SELECT * FROM logs WHERE inventory_id = p_inventory_id AND user_id = p_user_id
  ) THEN
    RAISE NOTICE 'Inventory ID: %, User ID: %, Quantity: %', p_inventory_id, p_user_id, p_quantity;
    UPDATE logs
    SET quantity = quantity + p_quantity
    WHERE inventory_id = p_inventory_id AND user_id = p_user_id;
  ELSE
    INSERT INTO logs (inventory_id, user_id, quantity)
    VALUES (p_inventory_id, p_user_id, p_quantity);
  END IF;
...
ALTER FUNCTION public.take_inventory(p_inventory_id integer, p_quantity integer, p_user_id uuid) OWNER TO postgres;
...
--
-- Name: overall_id_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--
...
--
-- Name: logs log_id_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: logs log_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: supplies overall_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: logs unique_inventory_user_logs; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.logs
    ADD CONSTRAINT unique_inventory_user_logs UNIQUE (inventory_id, user_id);
...
--
-- Name: crew crew_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.crew
    ADD CONSTRAINT crew_id_fkey FOREIGN KEY (id) REFERENCES auth.users(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: inventory inventory_supply_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: logs log_inventory_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.logs
    ADD CONSTRAINT log_inventory_id_fkey FOREIGN KEY (inventory_id) REFERENCES public.inventory(id);


--
-- Name: logs log_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
ALTER TABLE ONLY public.logs
    ADD CONSTRAINT logs_user_id_fkey FOREIGN KEY (user_id) REFERENCES public.crew(id);
...
--
-- Name: supplies Authenticated users can update supply_types; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: crew Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: inventory Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: logs Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: supplies Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: crew Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: inventory Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: logs Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: supplies Enable read access for all users; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: logs Enable update for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Enable update for authenticated users only" ON public.logs FOR UPDATE USING ((auth.uid() IS NOT NULL)) WITH CHECK ((auth.uid() IS NOT NULL));


--
-- Name: inventory Update for authenticated; Type: POLICY; Schema: public; Owner: postgres
--
...
--
-- Name: crew Update own crew records; Type: POLICY; Schema: public; Owner: postgres
--

CREATE POLICY "Update own crew records" ON public.crew FOR UPDATE TO authenticated USING ((id = auth.uid())) WITH CHECK ((id = auth.uid()));


--
-- Name: crew; Type: ROW SECURITY; Schema: public; Owner: postgres
--
...
--
-- Name: FUNCTION take_inventory(p_inventory_id integer, p_quantity integer, p_user_id uuid); Type: ACL; Schema: public; Owner: postgres
--

GRANT ALL ON FUNCTION public.take_inventory(p_inventory_id integer, p_quantity integer, p_user_id uuid) TO anon;
GRANT ALL ON FUNCTION public.take_inventory(p_inventory_id integer, p_quantity integer, p_user_id uuid) TO authenticated;
GRANT ALL ON FUNCTION public.take_inventory(p_inventory_id integer, p_quantity integer, p_user_id uuid) TO service_role;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.crew TO anon;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.crew TO authenticated;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.crew TO service_role;
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.supplies TO anon;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.supplies TO authenticated;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE public.supplies TO service_role;


--
-- Name: SEQUENCE overall_id_seq; Type: ACL; Schema: public; Owner: postgres
--
